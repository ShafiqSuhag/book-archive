...
1. search box & search button  http://openlibrary.org/search.json?q=${searchText}
2. Show result 
3. 404 handle 
3. Book Name , Author Name, Publisher , First Publishing Date, Multiple book info
4. Search count found

Bonus Marks 
6. all function should be arrow function 
7. array loop forEach 
8. === !==
9. Cover Phone ( large  dynamic cover_i)
10/ fetch / async 
11. 
